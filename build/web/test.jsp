...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/chosen.css"/>
...
<div class="form-group row align-items-center ">
  ...
  <div class="col-md-12">
    <select id="nationality" name="nationality" data-placeholder="Chọn quốc tịch" class="chosen-select form-control chosen">
      <option value=""></option>
